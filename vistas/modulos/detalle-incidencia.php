...
$datosRuta = ControladorRuta::ctrMostrarRutas("id",$incidencia["id_ruta"], null,null);
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Detalle servicio</h3>
                <ol class="breadcrumb">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            if($incidencia["hora_inicio"]!= "00:00:00" and $incidencia["hora_fin"] == "00:00:00") {
                                ...
                                echo '<div class="alert alert-info">
                                        <h3 class="text-info"><i class="fa fa-exclamation-circle"></i> Información</h3> Este servicio esta siendo atendido en este momento por el Técnico <b>'.$datosTecnico["nombre"].'</b>
                                    </div>';
                            }
                            ?>


                            <h3 class="card-title">Detalle servicio</h3>
                            ...
                            <div class="row form-group">
                                <div class="col-md-5 pad-b-inc">
                                    <label class="pl-2" for=""> Grupo</label>
                                    <select class="form-control custom-select" id="editGrupoInc" name="editGrupoInc" required <?php echo $read ?>>

                                        <?php
                                            echo '<option value="'.$incidencia["id_grupo"].'">'.$datosCliente["nombreGrupo"].'</option>';
                                        ?>
                                        ...
                                        foreach ($listaGrupoCliente as $key => $value) {
                                            ...
                                            if($incidencia["id_grupo"] != $value["id"]){
                                ...
                                <div class="col-md-7 pad-b-inc">
                                    <label class="pl-2" for=""> Tienda</label>
                                    <select class="form-control custom-select" id="editclienteInc" name="editclienteInc" required <?php echo $read ?>>

                                        <?php
                                            echo '<option value="'.$incidencia["id_cliente"].'">'.$datosCliente["alias"].' - '.$datosCliente["localizador"].' - '. $datosCliente["documento"] .'</option>';
                                        ?>
                                    </select>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-3 mt-3 margin-bot">

                                    <label class="pl-2" for=""> Ruta</label>
                                    <select class="form-control custom-select" id="editRuta" name="editRuta" <?php echo $read ?>>

                                        <?php
                                        if($incidencia["id_ruta"]==0){

                                            echo '<option value="">Seleccione una ruta</option>';

                                        }else{

                                            echo '<option value="'.$incidencia["id_ruta"].'">'.$datosRuta["nombre"].'</option>';
                                            echo '<option value="">Seleccione una ruta</option>';
                                        }
                                        ...
                                        foreach ($listaRuta as $key => $value) {
                                            ...
                                            if($incidencia["id_ruta"]==$value["id"]){
                            ...
                            <div class="input-group  " >
                                <textarea <?php echo $read ?> class="<?= $editar ?> form-control" rows="15"   name="editDescripcion" id="editDescripcion"><?php echo $incidencia["descripcion"] ?></textarea>
                            </div>
                            <br>
                                <!-- ARCHIVOS CARGADOS -->
                                <div class="form-group">
                                    ...
                                    if(count($imagenesArchivo)>0){
                                        ...
                                        $read = ($_SESSION["perfil"] == "Administrador") ? "" : "readonly";
                            ...
                            <div class="center-mov">
                                ...
                                if($incidencia["hora_inicio"]== "00:00:00" and $_SESSION["perfil"] == "Administrador") {
                                    ...
                                    echo '<button type="submit" class="btn btn-primary m-t-20" name="actualizarCompleto"><i class="fas fa-sync-alt"></i> Actualizar</button>';
                                }
                                ...
                                <a href="<?php echo $url ?>extensiones/tcpdf/pdf/incidencia.php?codigo=<?php echo $incidencia["id"]; ?>" class="btn btn-success m-t-20 " idIncidencia="<?php echo $incidencia["id"]; ?>" target="_blank"><i class="fa fa-print"></i> Imprimir</a>
                                ...
                                if($_SESSION["perfil"] == "Administrador"){
                                    ...
                                    //echo '<a href="#" id="subirFotos" class="btn btn-warning m-t-20" title="Subir fotos" data-toggle="modal" data-target="#modalSubirFotos" ><i class="fa fa-upload" aria-hidden="true"></i> Subir Fotos</a>';

                                    echo '<a href="#" id="verFotos" class="btn btn-warning m-t-20" style="margin-left: 4px" title="Subir Fotos" data-toggle="modal" data-target="#modalVerFotos" ><i class="fa fa-upload" aria-hidden="true"></i> Subir Fotos</a>';
