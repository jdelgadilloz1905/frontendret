...
$id_usuario = $_SESSION["id_grupo"];

$totalIncidencias = ControladorIncidencia::ctrContarIncidencias("id_grupo",$id_usuario);

$totalIncidenciasCerrada = ControladorIncidencia::ctrContarIncidenciasTecnico("estatus","cerrado","id_grupo",$id_usuario);

$totalIncidenciasAsignado = ControladorIncidencia::ctrContarIncidenciasTecnico("estatus","asignado","id_grupo",$id_usuario);

$totalIncidenciasPendiente = ControladorIncidencia::ctrContarIncidenciasTecnico("estatus","pendiente","id_grupo",$id_usuario);
                ...
                <div class="card">
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <a href="detalle-incidencia-grupo/'.$value["id"].'" class="btn btn-warning" title="Ver detalle"><i class="fas fa-eye"></i></a>
