...
$("#nuevoTipo, #editarTipo").change(function(){
          ...
          datosCategoria.append("idCategoria",respuesta["id_categoria"]);
           ...
           $.ajax({
              ...
              success:function(respuesta){
                  ...
                  $("#editarIdCategoriaActual").val(respuesta["id"]);
                  $("#editarCategoriaActual").val(respuesta["categoria"]);
		   ...
		   $("#editarTipoActual").val(respuesta["tipo"]);
