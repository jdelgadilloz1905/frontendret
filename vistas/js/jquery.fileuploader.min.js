...
(function($) {
    ...
    $.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            download: 'Descargar',
            remove: 'Borrar',
            drop: 'Deja los archivos aquí para subir',
            ...
            errors: {
                filesLimit: 'Solo se permiten subir ${limit} archivos .',
                filesType: 'Solo se pueden subir archivos ${extensions}.',
                fileSize: '${name} es demasiado grande! Elija un archivo de hasta ${fileMaxSize}MB.',
                filesSizeAll: '¡Los archivos que eligió son demasiado grandes! Por favor suba archivos hasta ${maxSize} MB.',
                fileName: 'El archivo con el nombre ${name} ya esta seleccionado.',
