    ...
    $bloque1 = <<<EOF
        ...
        <table>
            <tr>
                ...
                <td style="background-color:white; width:110px; text-align:center; color:red"><br><br>INCIDENCIA Nº<br>$id_incidencia</td>
            </tr>
        </table>
...
EOF;
    ...
    // ---------------------------------------------------------
        ...
        <table style="font-size:8.5px; padding:5px 10px;">
            ...
            <td style="border: 1px solid #666; background-color:white; text-align:center width:540px"><h1>HOJA DE SERVICIOS DE PLOMERIA</h1></td>
            ...
            <td style="border: 1px solid #666; background-color:white; width:270px; text-align:left">Fecha: $incidencia[fecha_visita]</td>
            ...
            <tr>
                ...
                <td style="border: 1px solid #666; background-color:white; text-align:center; width:270px"><h3>SERVICIOS REGULARES DE PLOMERIA</h3>
...
EOF;
        ...
        <table style="font-size:8.5px; padding:5px 10px;">
            ...
            <tr>
                <td style="width:270px">Supervisor de Turno: <strong>$datosUsuario[nombre]</strong></td>
            ...
            <tr>
                ...
                <td style="width:180px">Número Técnicos Adicionales: <strong>$servicio[tecnico_adicional]</strong></td>
            </tr>

            <tr>
                <td style="width:270px">Firma Cliente: <strong></strong></td>
