...
$respuestaIncidencia = ControladorIncidencia::ctrMostrarIncidencias($itemIncidencia, $valorIncidencia);

$listaCliente = ControladorClientes::ctrMostrarClientes(null,null);

$listaVendedor = ControladorUsuarios::ctrListaUsuariosFiltro("perfil","Vendedor");

//Busco el usuario quien creo la incidencia
$datosUsuario = ControladorUsuarios::ctrMostrarUsuarios("id",$respuestaIncidencia["id_usuario"]);

//Busco los datos del cliente

$datosCliente = ControladorClientes::ctrMostrarClientes("id",$respuestaIncidencia["id_cliente"]);

//Busco los datos del tecnico

$datosTecnico = ControladorUsuarios::ctrMostrarUsuarios("id",$respuestaIncidencia["id_tecnico"]);


$fecha = substr($respuestaIncidencia["fecha_visita"],0,-8);
...
$bloque1 = <<<EOF
	...
	<table>
		<tr>
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br>SERVICIO N.<br>$valorIncidencia</td>
		</tr>
	</table>
